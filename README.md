...
```
sudo pacman -S thunar xarchiver kitty cliphist rofi waybar swaync swww polkit-gnome xwayland-satellite hyprpicker wlogout brightnessctl neovim nwg-look fish 
yay -S niriswitcher sunsetr-bin swayosd yazi sioyek
```
Extras:
